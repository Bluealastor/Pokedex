...
export const Modal = ({ onClick, id, name, image, type, height, weight, stats, statsName }) => {
    return (
        <div style={{
            display: "flex",
            position: "fixed",
            ...
            backgroundImage: "linear-gradient(115deg,#fff1ff 48%, #f3533b 48% 55%, #fb7248 55%)",
            backgroundRepeat: "no-repeat",
            backGronudSize: "cover"
        }}>
            <div onClick={onClick}
                style={{ position:"absolute", top:"50px", right:"50px", borderRadius:"50%", padding:"5px 10px", background:"black", color:"white", 
                fontWeight:"900", cursor:"pointer", justifyItem:"end"
                }}>X</div>
                <div>
